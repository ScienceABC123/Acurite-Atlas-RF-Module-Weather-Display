...
*******************************************************************************/
					...
					// Display current solar description and draw sun symbol or moon phase
					// (source: arbitrary)
					...
					if (solar_adjusted >= 64) {
						...
						// modified to use the April 8, 2024 solar eclipse
						...
						a = 30.6001 * (b + 1);
						n = a;													// F
						a = l + c + m + n - 1524.5 + (d / 24);					// JD
						e = (a + 0.5 - 2460409.333333) / 29.53059;				// New moon on 8 Apr 2024, 20:00:00 gmt
						j = e;
						f = roundf(29.53059 * (e - j));
						if (f >= 30) {
							f = 0;
						}
						p = f;
						switch(p) {
							case 0:
								DisplayBMP(&Moon_0_BMP, x + 543 , y - 235);
								break;
							case 1:
								DisplayBMP(&Moon_1_BMP, x + 543 , y - 235);
								break;
							case 2:
								DisplayBMP(&Moon_2_BMP, x + 543 , y - 235);
								break;
							case 3:
								DisplayBMP(&Moon_3_BMP, x + 543 , y - 235);
								break;
							case 4:
								DisplayBMP(&Moon_4_BMP, x + 543 , y - 235);
								break;
							case 5:
								DisplayBMP(&Moon_5_BMP, x + 543 , y - 235);
								break;
							case 6:
								DisplayBMP(&Moon_6_BMP, x + 543 , y - 235);
								break;
							case 7:
								DisplayBMP(&Moon_7_BMP, x + 543 , y - 235);
								break;
							case 8:
								DisplayBMP(&Moon_8_BMP, x + 543 , y - 235);
								break;
							case 9:
								DisplayBMP(&Moon_9_BMP, x + 543 , y - 235);
								break;
							case 10:
								DisplayBMP(&Moon_10_BMP, x + 543 , y - 235);
								break;
							case 11:
								DisplayBMP(&Moon_11_BMP, x + 543 , y - 235);
								break;
							case 12:
								DisplayBMP(&Moon_12_BMP, x + 543 , y - 235);
								break;
							case 13:
								DisplayBMP(&Moon_13_BMP, x + 543 , y - 235);
								break;
							case 14:
								DisplayBMP(&Moon_14_BMP, x + 543 , y - 235);
								break;
							case 15:
								DisplayBMP(&Moon_15_BMP, x + 543 , y - 235);
								break;
							case 16:
								DisplayBMP(&Moon_16_BMP, x + 543 , y - 235);
								break;
							case 17:
								DisplayBMP(&Moon_17_BMP, x + 543 , y - 235);
								break;
							case 18:
								DisplayBMP(&Moon_18_BMP, x + 543 , y - 235);
								break;
							case 19:
								DisplayBMP(&Moon_19_BMP, x + 543 , y - 235);
								break;
							case 20:
								DisplayBMP(&Moon_20_BMP, x + 543 , y - 235);
								break;
							case 21:
								DisplayBMP(&Moon_21_BMP, x + 543 , y - 235);
								break;
							case 22:
								DisplayBMP(&Moon_22_BMP, x + 543 , y - 235);
								break;
							case 23:
								DisplayBMP(&Moon_23_BMP, x + 543 , y - 235);
								break;
							case 24:
								DisplayBMP(&Moon_24_BMP, x + 543 , y - 235);
								break;
							case 25:
								DisplayBMP(&Moon_25_BMP, x + 543 , y - 235);
								break;
							case 26:
								DisplayBMP(&Moon_26_BMP, x + 543 , y - 235);
								break;
							case 27:
								DisplayBMP(&Moon_27_BMP, x + 543 , y - 235);
								break;
							case 28:
								DisplayBMP(&Moon_28_BMP, x + 543 , y - 235);
								break;
							case 29:
								DisplayBMP(&Moon_29_BMP, x + 543 , y - 235);
								break;
						}
					}
					SelectColors(WHITE, BLACK);

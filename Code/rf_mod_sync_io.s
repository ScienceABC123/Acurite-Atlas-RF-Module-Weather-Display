...
// Setup to read the 27-byte packet from the RF module
		...
		movw	r5, #:lower16:TIMEOUT	// Set timeout counter to timeout value for all 27-bytes
		movt	r5, #:upper16:TIMEOUT

		mov	r6, #27			// Set byte counter to 27

// Read the 27-byte packet from the RF module

rfrdpkt3:

		mov	r7, #8			// Set bit counter to 8

// Wait for SCLK_OUT high

rfrdpkt4:

		subs	r5, r5, #1		// Decrement timeout counter
...
// Toggle SDAT_IN
		...
		subs	r7, r7, #1		// Decrement bit counter
